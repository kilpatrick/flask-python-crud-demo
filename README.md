...
Filenames prepended with graphql were generated by Cursor from my fully functional REST code. Everything else was written by me in Sublime Text (without AI generation, editing, or code completion.)
